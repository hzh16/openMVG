...
int main( int argc, char** argv )
{
  ...
  // Descriptor type
  cmd.add( make_option( 'd', sDescriptorCustomType, "descriptor_custom_type") );
  ...
  catch ( const std::string& s )
  {
    OPENMVG_LOG_INFO
      ...
      << "\n[Descriptor custom type:]\n"
      << "[-d|--descriptor_custom_type]\n"
      << "  DINOv2: 1536-dimensional descriptor generated by DINOv2\n"
      << "  DeepLabv3: 2048-dimensional descriptor generated by DeepLabv3\n"
      << "  REGULAR: other descriptors supported natively by openMVG";      
  ...
  if (sDescriptorCustomType == "DINOv2")
  {
    OPENMVG_LOG_INFO << "Using DINOv2 descriptors.";
    regions_type.reset(new features::DINOv2_Regions());
  }
  else
  if (sDescriptorCustomType == "DeepLabv3")
  {
    OPENMVG_LOG_INFO << "Using DeepLabv3 descriptors.";
    regions_type.reset(new features::DeepLabv3_Regions());
  }
  else
  {
